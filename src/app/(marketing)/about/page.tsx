...
export const metadata: Metadata = {
  ...
  description:
    "An Indian technology company building reliable storage, founded in Pune by Ramjit J. Mourya and now based in Mira Road, Thane.",
};
      ...
      <Section>
        <Reveal>
          <SectionHeader
            ...
            lead="Founded in Pune, now based in Mira Road, Thane. Serving customers across Maharashtra."
          />
