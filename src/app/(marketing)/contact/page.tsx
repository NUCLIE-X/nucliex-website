      ...
      <div className="grid gap-12 lg:grid-cols-12">
        ...
        <aside className="lg:col-span-4 lg:col-start-9">
          <div className="border-border rounded-lg border p-6">
            <h2 className="text-h4 text-brand-900 font-medium">NUCLIEX INFOSYS</h2>
            <ul className="text-body-sm mt-4 space-y-4">
              <li className="flex items-start gap-3">
                <MapPin size={18} strokeWidth={1.5} aria-hidden="true" className="text-fg-subtle mt-0.5 shrink-0" />
              ...
              <li className="flex items-center gap-3">
                <Phone size={18} strokeWidth={1.5} aria-hidden="true" className="text-fg-subtle shrink-0" />
                <span className="text-fg-muted">{company.phone}</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={18} strokeWidth={1.5} aria-hidden="true" className="text-fg-subtle shrink-0" />
              ...
              <li className="flex items-center gap-3">
                <Clock size={18} strokeWidth={1.5} aria-hidden="true" className="text-fg-subtle shrink-0" />
          ...
          <div className="border-border bg-surface-subtle mt-6 rounded-lg border border-dashed p-6">
